...
#         print(x[0].shape,x[1].shape)
        ...
        if save_best_only:
            checkpoint_path = tempfile.gettempdir()+'/NSIBF.weights.h5'
    ...
    def load_model(self,model_path=None):
        ...
        if model_path is None:
            model_path = tempfile.gettempdir()
        self.estimator = keras.models.load_model(model_path+'/NSIBF.h5', custom_objects={"mse": MeanSquaredError()})
        self.f_net = keras.models.load_model(model_path+'/NSIBF_f.h5', custom_objects={"mse": MeanSquaredError()})
        self.g_net = keras.models.load_model(model_path+'/NSIBF_g.h5', custom_objects={"mse": MeanSquaredError()})
        self.h_net = keras.models.load_model(model_path+'/NSIBF_h.h5', custom_objects={"mse": MeanSquaredError()})
